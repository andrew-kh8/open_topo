...
Welcome to your new gem! In this directory, you'll find the files you need to be able to package up your Ruby library into a gem. Put your Ruby code in the file `lib/open_topo`. To experiment with that code, run `bin/console` for an interactive prompt.
...
Everyone interacting in the OpenTopo project's codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/[USERNAME]/open_topo/blob/master/CODE_OF_CONDUCT.md).
